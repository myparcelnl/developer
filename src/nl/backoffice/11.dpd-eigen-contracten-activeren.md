...
- Log in op shipper.dpd.nl/login
  ...
  ::: note Let op!
  Het ‘Password’ wat je gebruikt om op DPD Shipper Webservices in te loggen, komt overeen met het ‘Password’ wat je voor je eigen contract in MyParcel op moet voeren.
  :::
...
- Indien er sprake is van 1 shop en 1 DPD contract, selecteer je DPD onder MyParcel backoffice > Accountinstellingen > MyContracts -> en vult vervolgens de juiste credentials in (Delis ID, Password en Depotcode)
  ...
  ::: note Let op!
  Om je wachtwoord en depotcode terug te vinden, ga je naar DPD Webservices. Kun je je wachtwoord en depotcode daar niet vinden, dan adviseren wij je contact op te nemen met je accountmanager.
  :::
