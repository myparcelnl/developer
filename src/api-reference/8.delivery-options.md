...
**Objects**  
Upon success two [arrays](#array) are returned; one for [DeliveryOptions](#9_A) and one for [PickupOptions](#9_B) objects is returned. This object contains delivery date, time and pricing. Upon error an Error object is returned.  

  
  
To show delivery options to customers, you can use our javascript [code](http://github.com/myparcelnl/checkout) . Use our [sandbox](https://myparcelnl.github.io/delivery-options/) for an example and easier integration.[

![](https://monosnap.com/image/mOGXF5KFCjVALnbjg67IgPB99bjLuV.png)
