...
When you want to retrieve ZPL labels you need to use a different Accept header. At this moment only PostNL labels are supported and you can only request one label at a time.
