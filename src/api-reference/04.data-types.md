...
<DataTypeDefinition values="1,2,3,4,5,9,10,11,12,13" example="1 (PostNL),2 (bpost. Only available on sendmyparcel.be),3 (CheapCargo/pallets),4 (DPD),9 (DHL For You),10 (DHL Parcel Connect),11 (DHL Europlus),12 (UPS Standard. Only available on MyParcel.nl), 13 (UPS Express Saver. Only available on MyParcel.nl)" />
