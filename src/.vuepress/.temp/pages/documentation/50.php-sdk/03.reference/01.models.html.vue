<template><p><code>MyParcelNL/Sdk/src/Model</code></p>
<h2 id="postnlconsignment" tabindex="-1"><a class="header-anchor" href="#postnlconsignment" aria-hidden="true">#</a> PostNLConsignment</h2>
<p><code>\MyParcelNL\Sdk\src\Model\Consignment\PostNLConsignment</code></p>
<h3 id="set-consignment-attributes" tabindex="-1"><a class="header-anchor" href="#set-consignment-attributes" aria-hidden="true">#</a> Set consignment attributes</h3>
...
</code></pre></div><h3 id="get-consignment-attributes" tabindex="-1"><a class="header-anchor" href="#get-consignment-attributes" aria-hidden="true">#</a> Get consignment attributes</h3>
<div class="language-php ext-php"><pre v-pre class="language-php"><code><span class="token variable">$consignment</span>
...
</code></pre></div><h4 id="myparcelcustomsitem" tabindex="-1"><a class="header-anchor" href="#myparcelcustomsitem" aria-hidden="true">#</a> MyParcelCustomsItem</h4>
<p>This object is embedded in the PostNLConsignment object for global shipments and
is mandatory for non-EU shipments.</p>
<p><code>MyParcelNL/Sdk/src/Model/MyParcelCustomsItem</code></p>
<div class="language-php ext-php"><pre v-pre class="language-php"><code>  <span class="token operator">-></span><span class="token function">setAmount</span><span class="token punctuation">(</span><span class="token number">3</span><span class="token punctuation">)</span> <span class="token comment">// Amount of items in the package</span>
