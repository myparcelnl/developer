<template><Stack class="grid-cols-2 sm:grid-cols-3">
    <Cta
        title="FAQ" 
...
<h2 id="send-us-a-message" tabindex="-1"><a class="header-anchor" href="#send-us-a-message" aria-hidden="true">#</a> Send us a message</h2>
<ContactForm />
</template>
