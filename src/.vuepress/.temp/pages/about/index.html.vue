<template><h2 id="meet-our-development-team" tabindex="-1"><a class="header-anchor" href="#meet-our-development-team" aria-hidden="true">#</a> Meet our development team! 🎉</h2>
<p>Our ambition is simple: Deliver a world-class shipment platform to our
...
on if you want to know more about our working method, tech stack and people!</p>
<Stack class="flex">
    <iframe 
        class="mx-auto"
        width="560" 
...
<h2 id="tech-stack" tabindex="-1"><a class="header-anchor" href="#tech-stack" aria-hidden="true">#</a> Tech Stack</h2>
<p>In order to provide the best possible SaaS Platform, we need state-of-the-art
...
<p>We like to experiment with promising new technologies and working methods. Agile
...
Development (with 100% test coverage ✨). Our integration team is always
busy crafting the best delivery checkout experience. And we'll continue finding
out ways to improve...</p>
<h2 id="team" tabindex="-1"><a class="header-anchor" href="#team" aria-hidden="true">#</a> Team</h2>
<h3 id="product-owners" tabindex="-1"><a class="header-anchor" href="#product-owners" aria-hidden="true">#</a> Product owners</h3>
...
<h3 id="integrations" tabindex="-1"><a class="header-anchor" href="#integrations" aria-hidden="true">#</a> Integrations</h3>
<Stack class="lg:grid-cols-3 sm:grid-cols-2 grid-cols-1">
    <TeamMember 
        name="Edie" 
...
<h3 id="devops" tabindex="-1"><a class="header-anchor" href="#devops" aria-hidden="true">#</a> DevOps</h3>
<Stack class="lg:grid-cols-3 sm:grid-cols-2 grid-cols-1">
...
<h2 id="join-us" tabindex="-1"><a class="header-anchor" href="#join-us" aria-hidden="true">#</a> Join us</h2>
<p>We are a fast-paced, fast-growing company and therefore (almost) always looking
for new talent. Feel free to meet us! You can find our job openings over
here. <AutoLink item="https://www.myparcel.nl/vacature/development/">Vacancies</AutoLink></p>
<Message title="" type="tip"><p>Using our API or SDK? Got some questions or
tips? <AutoLink item="https://join.slack.com/t/myparcel-dev/shared_invite/enQtNDkyNTg3NzA1MjM4LWQ5MWE5MTQ3MDg4YjU5NzdjYjk0OTY1ZDJiYjU5YzJjNzk3Yzk3NGY0OWFkZDU4MDYwZDEyZDlhZTgzOWM1MjI">Reach out to us on Slack!</AutoLink></p>
</Message></template>
