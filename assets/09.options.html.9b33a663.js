import{_ as t}from"./plugin-vue_export-helper.21dcd24c.js";import{o as e,c as o,b as s,a as r,w as l,e as a,d as n,r as c}from"./app.162befa7.js";const i={},k=a(`<div class="language-javascript ext-js"><pre class="language-javascript"><code>window<span class="token punctuation">.</span>MyParcelConfig <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token comment">// }</span>
</code></pre></div>`,2);function f(w,q){const p=c("AutoLink");return e(),o("div",null,[k,s("p",null,[u,y,d,m,g,v,h,r(p,{item:"https://myparcelnl.github.io/delivery-options/"},{default:l(()=>[b]),_:1})]),_])}var T=t(i,[["render",f],["__file","09.options.html.vue"]]);export{T as default};
