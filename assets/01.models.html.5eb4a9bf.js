import{_ as n}from"./plugin-vue_export-helper.21dcd24c.js";import{o as s,c as a,e as t}from"./app.f20652aa.js";const p={},e=t(`<p><code>MyParcelNL/Sdk/src/Model</code></p><h2 id="postnlconsignment" tabindex="-1"><a class="header-anchor" href="#postnlconsignment" aria-hidden="true" tabindex="-1">#</a> PostNLConsignment</h2><p><code>\\MyParcelNL\\Sdk\\src\\Model\\Consignment\\PostNLConsignment</code></p><h3 id="set-consignment-attributes" tabindex="-1"><a class="header-anchor" href="#set-consignment-attributes" aria-hidden="true" tabindex="-1">#</a> Set consignment attributes</h3><div class="language-php ext-php"><pre class="language-php"><code><span class="token variable">$consignment</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token keyword">new</span> <span class="token class-name class-name-fully-qualified"><span class="token punctuation">\\</span>MyParcelNL<span class="token punctuation">\\</span>Sdk<span class="token punctuation">\\</span>src<span class="token punctuation">\\</span>Model<span class="token punctuation">\\</span>Consignment<span class="token punctuation">\\</span>PostNLConsignment</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
...
</code></pre></div><h3 id="get-consignment-attributes" tabindex="-1"><a class="header-anchor" href="#get-consignment-attributes" aria-hidden="true" tabindex="-1">#</a> Get consignment attributes</h3><div class="language-php ext-php"><pre class="language-php"><code><span class="token variable">$consignment</span>
