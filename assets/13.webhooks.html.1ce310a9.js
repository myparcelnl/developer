import{_ as h}from"./plugin-vue_export-helper.21dcd24c.js";import{o as c,c as p,b as t,w as a,e as r,a as e,d as o,r as s}from"./app.e0bc0234.js";const u={},l=r(`<p>You can use our webhooks to keep track of changes in shipments, labels and your shop settings in the most efficient way.</p><p>Do note that most of our webhooks do not send a lot of data in the payload. They are more like a notification with a few properties to allow you to decide to proceed to send another request or not. This is for increased security and to reduce unnecessary bandwidth usage.</p><h3 id="prerequisites" tabindex="-1"><a class="header-anchor" href="#prerequisites" aria-hidden="true">#</a> Prerequisites</h3><ul><li>Your website must use HTTPS.</li></ul><h3 id="registering-a-webhook" tabindex="-1"><a class="header-anchor" href="#registering-a-webhook" aria-hidden="true">#</a> Registering a webhook</h3><p>Register a webhook by instantiating the <code>WebhookWebService</code> you want, passing your api key and executing <code>subscribe</code> with the URL you want to receive the payloads. You can only have one subscription to each webhook.</p><div class="language-php ext-php"><pre class="language-php"><code>$service = new \\MyParcelNL\\Sdk\\src\\Services\\Web\\Webhook\\ShipmentStatusChangeWebhookWebService();
