import{r as t,f as e,h as s,z as o,w as p,F as c,e as n,K as l,o as i}from"./app.48fbc8c7.js";import{_ as u}from"./plugin-vue_export-helper.21dcd24c.js";const r={},k=s("h2",{id:"myparcelcollection",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#myparcelcollection","aria-hidden":"true"},"#"),n(" MyParcelCollection")],-1),m=n("Stores all consignments to communicate with the MyParcel API. MyParcelCollection also contains almost "),d=n("all methods"),g=n(" from Laravel Collections. If you use Laravel it also extends "),f=s("code",null,"\\Illuminate\\Support\\Collection",-1),h=n("."),_=l(`<p><code>MyParcelNL/Sdk/src/Helper/MyParcelCollection.php</code></p><div class="language-php ext-php"><pre class="language-php"><code>    <span class="token comment">// Add consignment to collection</span>
