import{_ as t}from"./plugin-vue_export-helper.21dcd24c.js";import{o as s,c as r,a as o,b as i,w as c,e,d as a,r as d}from"./app.02e2e447.js";const l={},p=e(`<h3 id="usage-examples" tabindex="-1"><a class="header-anchor" href="#usage-examples" aria-hidden="true">#</a> Usage examples</h3><h4 id="basic-usage" tabindex="-1"><a class="header-anchor" href="#basic-usage" aria-hidden="true">#</a> Basic usage</h4><p>The client is Promise-based, so you can use <code>async/await</code>, or <code>Promise.then</code>.</p><p>First, instantiate an SDK and pass the endpoints you want to use.</p><div class="language-javascript ext-js"><pre class="language-javascript"><code>import { createPrivateSdk, PostShipments } from &#39;@myparcel/sdk&#39;;
