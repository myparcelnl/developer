import{_ as t}from"./plugin-vue_export-helper.21dcd24c.js";import{o as e,c as o,b as s,a as p,w as c,d as n,e as l,r as i}from"./app.f20652aa.js";const u={},r=s("h2",{id:"myparcelcollection",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#myparcelcollection","aria-hidden":"true",tabindex:"-1"},"#"),n(" MyParcelCollection")],-1),k=n("Stores all consignments to communicate with the MyParcel API. MyParcelCollection also contains almost "),d=n("all methods"),m=n(" from Laravel Collections. If you use Laravel it also extends "),g=s("code",null,"\\Illuminate\\Support\\Collection",-1),f=n("."),h=l(`<p><code>MyParcelNL/Sdk/src/Helper/MyParcelCollection.php</code></p><div class="language-php ext-php"><pre class="language-php"><code>    <span class="token comment">// Add consignment to collection</span>
...
</code></pre></div>`,2);function _(C,y){const a=i("AutoLink");return e(),o("div",null,[r,s("p",null,[k,p(a,{item:"https://laravel.com/docs/5.7/collections"},{default:c(()=>[d]),_:1}),m,g,f]),h])}var v=t(u,[["render",_],["__file","02.helpers.html.vue"]]);export{v as default};
