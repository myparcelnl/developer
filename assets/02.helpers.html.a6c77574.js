import{_ as t}from"./plugin-vue_export-helper.21dcd24c.js";import{o as e,c as o,a as s,b as p,w as c,d as n,e as l,r as i}from"./app.bcb55c99.js";const u={},r=s("h3",{id:"myparcelcollection",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#myparcelcollection","aria-hidden":"true",tabindex:"-1"},"#"),n(" MyParcelCollection")],-1),k=n("Stores all consignments to communicate with the MyParcel API. MyParcelCollection also contains almost "),d=n("all methods"),m=n(" from Laravel Collections. If you use Laravel it also extends "),g=s("code",null,"\\Illuminate\\Support\\Collection",-1),f=n("."),h=l(`<p><code>MyParcelNL/Sdk/src/Helper/MyParcelCollection.php</code></p><div class="language-php ext-php"><pre class="language-php"><code>    <span class="token comment">// Add consignment to collection</span>
