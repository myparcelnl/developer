...
</code></pre></div>`,5);function M(W,z){const a=r("AutoLink"),d=r("Message"),i=r("ApiLink");return c(),p("div",null,[u,e("ul",null,[_,e("li",null,[b,o(a,{item:"/api-reference/06.shipments#_6-B_2"},{default:s(()=>[g]),_:1}),m])]),o(d,{title:"",type:"tip"},{default:s(()=>[e("p",null,[f,o(a,{item:"https://webhook.site/"},{default:s(()=>[y]),_:1}),w])]),_:1}),E,e("p",null,[A,o(a,{item:"/api-reference/04.data-types#array"},{default:s(()=>[T]),_:1}),q,o(i,{to:"11_A"},{default:s(()=>[x]),_:1}),k]),v,e("p",null,[R,C,P,o(a,{item:"/api-reference/04.data-types#integer"},{default:s(()=>[j]),_:1}),U,S]),H,e("p",null,[B,I,N,o(a,{item:"/api-reference/04.data-types#integer"},{default:s(()=>[O]),_:1}),Y,K,D]),L])}var Q=h(l,[["render",M],["__file","10.webhooks.html.vue"]]);export{Q as default};
